...
class Users {
	...
	function __construct(){
		...
		$dbServer = '192.168.0.195'; //Define database server host
		$dbUsername = 'chrisrusso'; //Define database username
		$dbPassword = '1682951'; //Define database password
		$dbName = 'tmi'; //Define database name
